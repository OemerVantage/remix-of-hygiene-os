import { UtensilsCrossed, HeartPulse, Building2, Factory, GraduationCap } from "lucide-react";

const solutions = [
  {
    icon: UtensilsCrossed,
    title: "Gastronomie",
    description: "HACCP-konforme Lösungen für Küche und Service",
  },
  {
    icon: HeartPulse,
    title: "Gesundheitswesen",
    description: "Höchste Standards für Kliniken und Praxen",
  },
  {
    icon: Building2,
    title: "Büro",
    description: "Moderne Hygiene für Arbeitsplätze",
  },
  {
    icon: Factory,
    title: "Industrie",
    description: "Robuste Systeme für Produktionsumgebungen",
  },
  {
    icon: GraduationCap,
    title: "Bildung",
    description: "Sichere Hygiene für Schulen und Universitäten",
  },
];
          ...
          {solutions.map((solution, index) => (
            ...
            >
              <div className="w-14 h-14 md:w-16 md:h-16 mx-auto mb-4 rounded-xl bg-accent flex items-center justify-center group-hover:bg-primary transition-colors duration-300">
                <solution.icon className="w-7 h-7 md:w-8 md:h-8 text-primary group-hover:text-primary-foreground transition-colors duration-300" />
              </div>
